...
namespace Workbench_Example.View.Behavior
{
    /// <summary>
    ...
    public static class AvalonDockLayoutSerializer
    {
        ...
        private static readonly DependencyProperty LoadLayoutCommandProperty = DependencyProperty.RegisterAttached("LoadLayoutCommand", typeof(ICommand), typeof(AvalonDockLayoutSerializer), new PropertyMetadata(null, AvalonDockLayoutSerializer.OnLoadLayoutCommandChanged));
        private static readonly DependencyProperty SaveLayoutCommandProperty = DependencyProperty.RegisterAttached("SaveLayoutCommand", typeof(ICommand), typeof(AvalonDockLayoutSerializer), new PropertyMetadata(null, AvalonDockLayoutSerializer.OnSaveLayoutCommandChanged));
